...
parser.add_argument("--pretrained_model_path", type=str, default="./pretrained_model/chinese_roberta_wwm_ext",help="pretrained_model_path") #预训练模型路径
...
parser.add_argument("--decay_epoch", type=str, default=8,help="decay_steps")
